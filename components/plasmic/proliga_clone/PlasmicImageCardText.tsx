...
import sty from "./PlasmicImageCardText.module.css"; // plasmic-import: lLmb8rgQYtAr/css
    ...
    >
      ...
      >
        <PlasmicImg__
          ...
          loading={"lazy"}
          src={{
            src: "/plasmic/proliga_clone/images/_1350731Jpeg.jpg",
            fullWidth: 3840,
            fullHeight: 2160,
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.column__r7NP)}>
              <div
                className={classNames(
                  projectcss.all,
            ...
            <Stack__
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.column__tpCDc)}
            >
              <div
                className={classNames(
                  projectcss.all,
