...
import SignInButtons from "../../SignInButtons"; // plasmic-import: jmZ-fE2jUI80/component
import SearchComponent from "../../SearchComponent"; // plasmic-import: 0ukHYUnov3Ae/component
import { CmsQueryRepeater } from "@plasmicpkgs/plasmic-cms";
import { CmsRowImage } from "@plasmicpkgs/plasmic-cms";
import { CmsRowField } from "@plasmicpkgs/plasmic-cms";
import MatchesCalendar from "../../MatchesCalendar"; // plasmic-import: oorJTY2gBOX1/component
...
import sty from "./PlasmicHomepage.module.css"; // plasmic-import: v4llJqhV1j_j/css
        ...
        >
          ...
          >
            ...
            >
              ...
              <div className={classNames(projectcss.all, sty.freeBox__e15PE)}>
                <CmsQueryRepeater
                  className={classNames(
                    "__wab_instance",
                    sty.cmsDataFetcher___4WyxF
                  )}
                  desc={false}
                  emptyMessage={
                    <DataCtxReader__>
                    ...
                    {$ctx => (
                      ...
                      >
                        <CmsRowImage
                          className={classNames(
                            "__wab_instance",
                            sty.cmsEntryImage__sFnXm
                          )}
                          srcProp={"src"}
                        >
                          <PlasmicImg__
                            alt={""}
                            className={classNames(sty.img__ylFYi)}
                            displayHeight={"auto"}
              ...
              <div className={classNames(projectcss.all, sty.freeBox__xnvvT)}>
                <CmsQueryRepeater
                  className={classNames(
                    "__wab_instance",
                    sty.cmsDataFetcher__aI0Yk
                  )}
                  desc={false}
                  emptyMessage={
                    <DataCtxReader__>
                    ...
                    {$ctx => (
                      ...
                      >
                        <CmsRowImage
                          className={classNames(
                            "__wab_instance",
                            sty.cmsEntryImage__yaiaL
                          )}
                          srcProp={"src"}
                        >
                          <PlasmicImg__
                            alt={""}
                            className={classNames(sty.img__zeSmw)}
                            displayHeight={"auto"}
                            displayMaxHeight={"none"}
                            displayMaxWidth={"none"}
                            displayMinHeight={"0"}
            ...
            <Stack__
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox__jD4QL)}
            >
              <h3
                className={classNames(
                  projectcss.all,
          ...
          <div className={classNames(projectcss.all, sty.columns__zeVCg)}>
            <div className={classNames(projectcss.all, sty.column__xUrGc)}>
              <PlasmicLink__
                className={classNames(
                  projectcss.all,
                  projectcss.a,
            ...
            <div className={classNames(projectcss.all, sty.column__d5P8W)}>
              <PlasmicLink__
                className={classNames(
                  projectcss.all,
                  projectcss.a,
          ...
          <div className={classNames(projectcss.all, sty.freeBox__dzsM8)}>
            <div
              className={classNames(
                projectcss.all,
                projectcss.__wab_text,
          ...
          <div className={classNames(projectcss.all, sty.columns__pltos)}>
            <div className={classNames(projectcss.all, sty.column___3Ap4X)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
            ...
            <div className={classNames(projectcss.all, sty.column__jB9La)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__skKqm)}
                displayHeight={"auto"}
                displayMaxHeight={"none"}
                displayMaxWidth={"100%"}
                displayMinHeight={"0"}
            ...
            <div className={classNames(projectcss.all, sty.column__ruZc)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <MarketMember
                className={classNames("__wab_instance", sty.marketMember__ugEx)}
              />
