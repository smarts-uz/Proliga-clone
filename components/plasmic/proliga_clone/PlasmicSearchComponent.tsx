...
import sty from "./PlasmicSearchComponent.module.css"; // plasmic-import: 0ukHYUnov3Ae/css
...
function PlasmicSearchComponent__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <div className={classNames(projectcss.all, sty.column__l7BHg)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.column___1STs6)}>
          <div className={classNames(projectcss.all, sty.freeBox___8ZUBh)}>
            <PlasmicImg__
            ...
            <div className={classNames(projectcss.all, sty.freeBox__lS3Bj)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
