...
import sty from "./PlasmicButton.module.css"; // plasmic-import: zAmS4vc8WNH5/css
    ...
    <Stack__
      ...
      className={classNames(
        ...
        sty.login,
        {
          ...
          [sty.loginshape_sharp_size_compact_color_blue]:
            hasVariant($state, "color", "blue") &&
            hasVariant($state, "size", "compact") &&
          ...
          [sty.loginshowStartIcon_size_compact]:
            hasVariant($state, "size", "compact") &&
            hasVariant($state, "showStartIcon", "showStartIcon"),
          [sty.loginshowStartIcon_size_compact_showEndIcon]:
            hasVariant($state, "size", "compact") &&
            hasVariant($state, "showStartIcon", "showStartIcon") &&
            hasVariant($state, "showEndIcon", "showEndIcon"),
          ...
          [sty.loginsize_compact_color_sand_shape_rounded]:
            hasVariant($state, "size", "compact") &&
            hasVariant($state, "shape", "rounded") &&
          ...
          [sty.loginsize_compact_shape_rounded]:
            hasVariant($state, "size", "compact") &&
            hasVariant($state, "shape", "rounded"),
          [sty.loginsize_compact_showEndIcon]:
            hasVariant($state, "size", "compact") &&
            hasVariant($state, "showEndIcon", "showEndIcon"),
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__icrNj)}
              role={"img"}
            />
          ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__qs1El)}
                role={"img"}
              />
            ),
