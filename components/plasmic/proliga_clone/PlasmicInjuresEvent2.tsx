...
import sty from "./PlasmicInjuresEvent2.module.css"; // plasmic-import: P6JTouySl2C4/css
...
function PlasmicInjuresEvent2__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox___3VZfv)}>
        <div
          data-plasmic-name={"columns"}
          data-plasmic-override={overrides.columns}
          className={classNames(projectcss.all, sty.columns)}
        >
          <div className={classNames(projectcss.all, sty.column__kzKc4)}>
            <div className={classNames(projectcss.all, sty.freeBox___1Cy6)}>
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__kzvbw)}
            ...
            <div className={classNames(projectcss.all, sty.freeBox__lhlDu)}>
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__qyRso)}
                displayHeight={"32.5px"}
                displayMaxHeight={"none"}
                displayMaxWidth={"100%"}
                displayMinHeight={"0"}
            ...
            <div className={classNames(projectcss.all, sty.freeBox___46Lvh)}>
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img___9Edrt)}
                displayHeight={"32.5px"}
                displayMaxHeight={"none"}
                displayMaxWidth={"100%"}
                displayMinHeight={"0"}
          ...
          <div className={classNames(projectcss.all, sty.column__d0KBm)}>
            <div className={classNames(projectcss.all, sty.freeBox__gGFrt)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__zuUwI)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__fki9I)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
