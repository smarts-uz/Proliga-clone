...
import sty from "./PlasmicBreakinNewsCards.module.css"; // plasmic-import: -CAxuSpdcwSM/css
...
function PlasmicBreakinNewsCards__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__cX6PR)}>
        <PlasmicImg__
        ...
        <div className={classNames(projectcss.all, sty.freeBox___50EtV)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div
          className={classNames(
            ...
            sty.text__cr6Mq,
            {
              [sty.textrmTeam__cr6MqPDq6H]: hasVariant(
                $state,
                "rmTeam",
                "rmTeam"
              ),
              [sty.textvariant2__cr6MqorJb5]: hasVariant(
                $state,
                "variant2",
                "variant2"
              ),
              [sty.textvariant3__cr6Mq83VZf]: hasVariant(
                $state,
                "variant3",
                "variant3"
              )
        ...
        <div
          className={classNames(
            ...
            sty.text__wCKj,
            {
              [sty.textrmTeam__wCKjpDq6H]: hasVariant(
                $state,
                "rmTeam",
                "rmTeam"
              ),
              [sty.textvariant2__wCKJorJb5]: hasVariant(
                $state,
                "variant2",
                "variant2"
              ),
              [sty.textvariant3__wCKj83VZf]: hasVariant(
                $state,
                "variant3",
                "variant3"
              )
