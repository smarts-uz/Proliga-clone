...
import sty from "./PlasmicInjuredClub.module.css"; // plasmic-import: PzqM6eAv2KE4/css
  ...
  return (
    ...
    >
      ...
      >
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__iVzYy, {
            [sty.imgvariant1__iVzYy6Ape]: hasVariant(
              $state,
              "variant1",
              "variant1"
            ),
            [sty.imgvariant2__iVzYYmFDm4]: hasVariant(
              $state,
              "variant2",
              "variant2"
            ),
            [sty.imgvariant3__iVzYyKQp]: hasVariant(
              $state,
              "variant3",
              "variant3"
            )
        ...
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__rLa4X)}
          displayHeight={"auto"}
          displayMaxHeight={"none"}
          displayMaxWidth={"100%"}
          displayMinHeight={"0"}
