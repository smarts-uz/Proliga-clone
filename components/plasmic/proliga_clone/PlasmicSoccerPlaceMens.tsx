...
import IdealTeamMember from "../../IdealTeamMember"; // plasmic-import: 3sMgr_WWMxTJ/component
...
import sty from "./PlasmicSoccerPlaceMens.module.css"; // plasmic-import: Uwp5HzTGECos/css
...
function PlasmicSoccerPlaceMens__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__dC5Ti)}>
        <IdealTeamMember
          className={classNames("__wab_instance", sty.idealTeamMember__ayaNk)}
        />
      </div>
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__zlqHp)}
      >
        <IdealTeamMember
          className={classNames("__wab_instance", sty.idealTeamMember__am3R5)}
          sergioRamos={true}
        />

        <IdealTeamMember
          className={classNames("__wab_instance", sty.idealTeamMember__bcBti)}
          johnPache2={true}
        />

        <IdealTeamMember
          className={classNames("__wab_instance", sty.idealTeamMember__eEjPo)}
          mingueza={true}
        />
      </Stack__>
      <div className={classNames(projectcss.all, sty.freeBox__mixAw)}>
        <IdealTeamMember
          className={classNames("__wab_instance", sty.idealTeamMember__mtMh)}
          zakaryan={true}
        />

        <IdealTeamMember
          className={classNames("__wab_instance", sty.idealTeamMember___7C3Jf)}
          ikerMundez={true}
        />

        <IdealTeamMember
          className={classNames("__wab_instance", sty.idealTeamMember__ioQy0)}
          robertNav={true}
        />

        <IdealTeamMember
          alcaraz={true}
          className={classNames("__wab_instance", sty.idealTeamMember__buOjE)}
        />
      </div>
      <div className={classNames(projectcss.all, sty.freeBox__lfxLf)}>
        <IdealTeamMember
          className={classNames("__wab_instance", sty.idealTeamMember__cBuCx)}
          rodrygo={true}
        />

        <IdealTeamMember
          className={classNames("__wab_instance", sty.idealTeamMember__sLbck)}
          dovbyk={true}
        />

        <IdealTeamMember
          className={classNames("__wab_instance", sty.idealTeamMember__iGfSb)}
          willianJose={true}
        />
      </div>
    </div>
