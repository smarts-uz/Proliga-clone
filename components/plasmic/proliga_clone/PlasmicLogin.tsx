...
import AuthComponent from "../../AuthComponent"; // plasmic-import: YeYKjN6xaEZL/component
import LoginRegister from "../../LoginRegister"; // plasmic-import: vMY1pL7uXDdt/component
...
import sty from "./PlasmicLogin.module.css"; // plasmic-import: vvWzcKbbDrNB/css
  ...
  return (
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <AuthComponent
            className={classNames("__wab_instance", sty.authComponent___8OqJv)}
          />
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__sx7HD)}>
              <div
                className={classNames(
                  projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__t12nd)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__zqYgh)}
                displayHeight={"26px"}
            ...
            <div className={classNames(projectcss.all, sty.freeBox__r3QN3)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__yFm9S)}
                displayHeight={"auto"}
                displayMaxHeight={"none"}
                displayMaxWidth={"100%"}
                displayMinHeight={"0"}
            ...
            <div className={classNames(projectcss.all, sty.freeBox__w3C9I)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__nmkwb)}
                displayHeight={"auto"}
                displayMaxHeight={"none"}
                displayMaxWidth={"100%"}
                displayMinHeight={"0"}
            ...
            <div className={classNames(projectcss.all, sty.freeBox__lJpY)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
          ...
          <AuthComponent
            className={classNames("__wab_instance", sty.authComponent__rCxlx)}
          />
        </div>
      </div>
    </React.Fragment>
