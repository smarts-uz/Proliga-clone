...
import sty from "./PlasmicRankings2.module.css"; // plasmic-import: 7vC8NBhjnHgz/css
...
function PlasmicRankings2__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__nnHNx)}>
        <CmsQueryRepeater
          ...
          <DataCtxReader__>
            {$ctx =>
              (_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))([
                ...
                return (
                  <div
                    className={classNames(projectcss.all, sty.freeBox__gBqvp)}
                    key={currentIndex}
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__iOb6R)}
                    >
                      <CmsRowField
                        className={classNames(
                          "__wab_instance",
                          sty.cmsEntryField__nYKlG
                        )}
                        field={"avatar"}
