...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: Feg8zJ_JrfC-/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__egTgm)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__mcAi)}
              role={"img"}
            />
          ),
