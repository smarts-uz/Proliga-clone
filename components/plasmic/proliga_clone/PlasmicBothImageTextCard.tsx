...
import sty from "./PlasmicBothImageTextCard.module.css"; // plasmic-import: Q2xSi8WMVGiG/css
...
function PlasmicBothImageTextCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__atzrT)}>
        <PlasmicImg__
      ...
      <div className={classNames(projectcss.all, sty.freeBox__pAVl)}>
        <div className={classNames(projectcss.all, sty.freeBox__qSBj)}>
          <Stack__
            as={"div"}
          ...
          >
            <div className={classNames(projectcss.all, sty.column__mGx3U)}>
              <div
                className={classNames(
                  projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.column__upMhO)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
