...
import sty from "./PlasmicInjuredEvent5.module.css"; // plasmic-import: gnHuD2MuVC1G/css
...
function PlasmicInjuredEvent5__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <div className={classNames(projectcss.all, sty.column___7Ovq7)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div
          className={classNames(projectcss.all, sty.column__vvKZf, {
            [sty.columngoalsAgainst__vvKZfFvwWi]: hasVariant(
              $state,
              "goalsAgainst",
              "goalsAgainst"
            )
        ...
        >
          <div
            className={classNames(
              ...
              sty.text___0JwHd,
              {
                [sty.textballsIntoTheBox___0JwHdWf3Sk]: hasVariant(
                  $state,
                  "ballsIntoTheBox",
                  "ballsIntoTheBox"
                ),
                [sty.textbigChanceCreated___0JwHd6Wejx]: hasVariant(
                  $state,
                  "bigChanceCreated",
                  "bigChanceCreated"
                ),
                [sty.textcommitedPenalties___0JwHdGtyAy]: hasVariant(
                  $state,
                  "commitedPenalties",
                  "commitedPenalties"
                ),
                [sty.texteffectiveClearanes___0JwHd0ErV]: hasVariant(
                  $state,
                  "effectiveClearanes",
                  "effectiveClearanes"
                ),
                [sty.texteffectiveDribbles___0JwHdVt6Je]: hasVariant(
                  $state,
                  "effectiveDribbles",
                  "effectiveDribbles"
                ),
                [sty.textgoalAssists___0JwHd6TnCk]: hasVariant(
                  $state,
                  "goalAssists",
                  "goalAssists"
                ),
                [sty.textgoalAttempts___0JwHdixX4R]: hasVariant(
                  $state,
                  "goalAttempts",
                  "goalAttempts"
                ),
                [sty.textgoalsAgainst___0JwHdFvwWi]: hasVariant(
                  $state,
                  "goalsAgainst",
                  "goalsAgainst"
                ),
                [sty.textgoals___0JwHdb0Ugm]: hasVariant(
                  $state,
                  "goals",
                  "goals"
                ),
                [sty.textlostBalls___0JwHdviekU]: hasVariant(
                  $state,
                  "lostBalls",
                  "lostBalls"
                ),
                [sty.textownGoals___0JwHdCxHqA]: hasVariant(
                  $state,
                  "ownGoals",
                  "ownGoals"
                ),
                [sty.textpenaltiesMissed___0JwHdfg3P1]: hasVariant(
                  $state,
                  "penaltiesMissed",
                  "penaltiesMissed"
                ),
                [sty.textpenaltiesSaved___0JwHdBoGFc]: hasVariant(
                  $state,
                  "penaltiesSaved",
                  "penaltiesSaved"
                ),
                [sty.textpenaltiesWon___0JwHdZBtYa]: hasVariant(
                  $state,
                  "penaltiesWon",
                  "penaltiesWon"
                ),
                [sty.textrecoviries___0JwHdOp4Ta]: hasVariant(
                  $state,
                  "recoviries",
                  "recoviries"
                ),
                [sty.textredCard___0JwHdy53Qg]: hasVariant(
                  $state,
                  "redCard",
                  "redCard"
                ),
                [sty.textsaves___0JwHdIIxWf]: hasVariant(
                  $state,
                  "saves",
                  "saves"
                ),
                [sty.textsecondaryYellowCard___0JwHdi3ZaH]: hasVariant(
                  $state,
                  "secondaryYellowCard",
                  "secondaryYellowCard"
                ),
                [sty.textyellowCard___0JwHdODbA]: hasVariant(
                  $state,
                  "yellowCard",
                  "yellowCard"
                )
        ...
        <div className={classNames(projectcss.all, sty.column__x85Kv)}>
          <div
            className={classNames(
              projectcss.all,
              projectcss.__wab_text,
