...
import sty from "./PlasmicInjuredTeamMember.module.css"; // plasmic-import: Za4OiNkpB-JO/css
  ...
  return (
    ...
    >
      ...
      >
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__smQVu)}
          displayHeight={"auto"}
        ...
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__ob8Z6)}
          displayHeight={"20px"}
          displayMaxHeight={"none"}
          displayMaxWidth={"100%"}
          displayMinHeight={"0"}
          ...
          loading={"lazy"}
          src={{
            src: "/plasmic/proliga_clone/images/crossMedicalCircle512Webp.webp",
            fullWidth: 512,
            fullHeight: 512,
            aspectRatio: undefined
          }}
