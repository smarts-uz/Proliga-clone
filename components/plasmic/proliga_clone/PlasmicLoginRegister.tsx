...
import sty from "./PlasmicLoginRegister.module.css"; // plasmic-import: vMY1pL7uXDdt/css
  ...
  return (
    ...
    >
      {renderPlasmicSlot({
        defaultContents: (
          <React.Fragment>
            <div className={classNames(projectcss.all, sty.freeBox__xUwQ)}>
              <div
                className={classNames(
                  projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__aeyJ7)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img___5HgAw)}
                displayHeight={"26px"}
            ...
            <div className={classNames(projectcss.all, sty.freeBox__aUl2A)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__i8GcA)}
                displayHeight={"auto"}
                displayMaxHeight={"none"}
                displayMaxWidth={"100%"}
                displayMinHeight={"0"}
            ...
            <div className={classNames(projectcss.all, sty.freeBox___0GWvg)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__eNkmB)}
                displayHeight={"auto"}
                displayMaxHeight={"none"}
                displayMaxWidth={"100%"}
                displayMinHeight={"0"}
            ...
            <TextInput
              autoFocus={false}
              className={classNames("__wab_instance", sty.textInput__s2MVc)}
              name={"Email"}
              type={"email"}
              value={(() => {
                try {
            ...
            <TextInput
              className={classNames("__wab_instance", sty.textInput__yKUdD)}
            ...
            <div className={classNames(projectcss.all, sty.freeBox__knYTf)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
