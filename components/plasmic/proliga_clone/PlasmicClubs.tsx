...
import sty from "./PlasmicClubs.module.css"; // plasmic-import: XYlT5RCMFzG3/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__y1T2V)}
      >
        <CmsQueryRepeater
        ...
        >
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__hyaVy)}>
                <PlasmicLink__
