...
import sty from "./PlasmicMatchesCalendar.module.css"; // plasmic-import: oorJTY2gBOX1/css
...
function PlasmicMatchesCalendar__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__zclHf)}>
        <CmsQueryRepeater
          ...
          <DataCtxReader__>
            {$ctx => (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__shGw7)}
              >
                <div className={classNames(projectcss.all, sty.freeBox__dCgul)}>
                  <CmsRowField
                    className={classNames(
                      "__wab_instance",
                      sty.cmsEntryField___67YV
                    )}
                ...
                <div className={classNames(projectcss.all, sty.freeBox__usaDr)}>
                  <div
                    className={classNames(
                      projectcss.all,
                      projectcss.__wab_text,
                ...
                <div className={classNames(projectcss.all, sty.freeBox__bx4VW)}>
                  <CmsRowField
                    className={classNames(
                      "__wab_instance",
                      sty.cmsEntryField__hg1Cw
                    )}
                    field={(() => {
                      try {
                        return undefined;
