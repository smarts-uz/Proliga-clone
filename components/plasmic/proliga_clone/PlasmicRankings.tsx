...
import Rankings2 from "../../Rankings2"; // plasmic-import: 7vC8NBhjnHgz/component
...
import sty from "./PlasmicRankings.module.css"; // plasmic-import: jkMuIqNuxOTc/css
    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          <div className={classNames(projectcss.all, sty.freeBox__vg6Sd)}>
            <div
              className={classNames(
                projectcss.all,
          ...
          <div className={classNames(projectcss.all, sty.freeBox__qritM)}>
            <Stack__
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox__lqFsu)}
            >
              <AntdDropdown
                className={classNames("__wab_instance", sty.dropdown___0QYgz)}
                dropdownMenuScopeClassName={
                  sty["dropdown___0QYgz__dropdownMenu"]
                }
                menuItems={() => (
                  <React.Fragment>
                    <AntdMenuItem
              ...
              >
                <AntdButton
                  className={classNames("__wab_instance", sty.button__kYdKa)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
              ...
              <AntdDropdown
                className={classNames("__wab_instance", sty.dropdown___5QmiT)}
                dropdownMenuScopeClassName={
                  sty["dropdown___5QmiT__dropdownMenu"]
                }
                menuItems={() => (
                  <React.Fragment>
                    <AntdMenuItem
              ...
              >
                <AntdButton
                  className={classNames("__wab_instance", sty.button__ojxhf)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
              ...
              <AntdDropdown
                className={classNames("__wab_instance", sty.dropdown__vtD5O)}
                dropdownMenuScopeClassName={
                  sty["dropdown__vtD5O__dropdownMenu"]
                }
                menuItems={() => (
                  <React.Fragment>
                    <AntdMenuItem
              ...
              >
                <AntdButton
                  className={classNames("__wab_instance", sty.button__oSp1I)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__zsu4V)}>
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__oqFHo)}
              >
                <div
                  className={classNames(projectcss.all, sty.freeBox___9ALJa)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__mUaxH)}>
                <div className={classNames(projectcss.all, sty.freeBox__vEnXl)}>
                  <div
                    className={classNames(
                      projectcss.all,
                      projectcss.__wab_text,
                  ...
                  <div
                    className={classNames(projectcss.all, sty.freeBox__r3Zm)}
                  >
                    <PlasmicImg__
