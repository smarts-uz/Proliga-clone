...
import sty from "./PlasmicSignInButtons.module.css"; // plasmic-import: jmZ-fE2jUI80/css
...
function PlasmicSignInButtons__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__bxWId)}>
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__jrrMd)}
        >
          <Button className={classNames("__wab_instance", sty.button__aFiE3)}>
            <div
              className={classNames(
                projectcss.all,
          ...
          <PlasmicLink__
            ...
            target={"_blank"}
          >
            <Button className={classNames("__wab_instance", sty.button__lqBim)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
